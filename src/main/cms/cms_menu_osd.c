...
static const OSD_Entry menuOsdElemsEntries[] =
{
    ...
    OSD_ELEMENT_ENTRY("TERRAIN MODE", OSD_TERRAIN_MODE),
    ...
    OSD_ELEMENT_ENTRY("BARO_READING", OSD_BARO_READING),
    OSD_ELEMENT_ENTRY("RANGEFINDER_READING", OSD_RANGEFINDER_READING),
    OSD_ELEMENT_ENTRY("RANGEFINDER_RAW_READING", OSD_RANGEFINDER_RAW_READING),
    OSD_ELEMENT_ENTRY("DEPTH", OSD_DEPTH),
